...
// all written by Jolanta CPRG 211 Teacher // comments made by Alex Raagas
namespace Lab0
{
    internal static class Utilities
    {
        // doesn't specify whether numbers should be an integer only asks if the number is positive thus using two functions GetPositiveDdecimal and GetPositiveInt
        /// <summary>
        ...
        // gets users high numbers, it checks if it is lower than lower number as well checks if it is not a whole number.
        /// <summary>
        /// reads int in range
        /// </summary>
        /// <param name="prompt">name used in error messages</param>
